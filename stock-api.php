...
class Stock_Tracker_API {
	...
	public function register_endpoints() {
		// Get all stocks
		register_rest_route( 'stock-tracker/v1', '/stocks', [ 
			'methods'             => 'GET',
		...
		register_rest_route( 'stock-tracker/v1', '/stocks/(?P<category>[a-zA-Z]+)', [ 
			'methods'             => 'GET',
		...
		register_rest_route( 'stock-tracker/v1', '/stocks/update', [ 
			'methods'             => 'POST',
		...
		register_rest_route( 'stock-tracker/v1', '/stocks/bulk-update', [ 
			'methods'             => 'POST',
